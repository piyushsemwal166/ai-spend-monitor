...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5 sm:gap-5">
        {[
      ...
      <section className="grid gap-5 xl:grid-cols-[1.3fr_0.7fr] sm:gap-6">
        ...
        <Card className="border-white/10 bg-white/75 dark:bg-slate-950/55">
          ...
          <CardContent className="space-y-3 p-4 text-sm text-slate-500 dark:text-slate-400 sm:p-6">
